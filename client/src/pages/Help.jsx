...
export default function Help() {
  ...
  return (
    <>
      <button
        className="bg-white btn btn-square p-0.5 btn-ghost rounded-full"
      ...
      {isOpen && (
        <dialog open className="modal modal-open"
          aria-hidden={!isOpen} role="dialog">
          <div className="modal-box">
            ...
            <div className="space-y-4">
              <section>
                ...
                <p>There is <span className="font-bold">no limit</span> to the number of players who can join a game.</p>
              </section>

              <section>
                <h2 className="text-lg font-semibold">❓ Quiz Format</h2>
                <p>The game includes <span className="font-bold">10 questions</span>, each with <span className="font-bold">4 possible answers</span>.</p>
              </section>

              <section>
                <h2 className="text-lg font-semibold">⏳ Answering Time</h2>
                <p>Players have <span className="font-bold">10 seconds</span> to select their answer before the time is up.</p>
              </section>

              <section>
                <h2 className="text-lg font-semibold">⚡ Points & Winning</h2>
                <ul className="list-disc pl-5">
                  <li>The <span className="font-bold">fastest player</span> to choose the correct answer scores a point.</li>
                  <li>Wrong answers do not affect your score.</li>
                  <li>The player with the <span className="font-bold">highest total score</span> at the end wins the game! 🏆</li>
                </ul>
              </section>
            </div>

            <div className="modal-action">
              <button className="btn btn-primary" onClick={() => setIsOpen(false)} aria-label="Close game rules">
                Got It!
              </button>
            </div>
          </div>
